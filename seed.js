...
async function run() {
  try {
    ...
    const professionalsData = [
      {
        name: 'Mahesh Kumar', initials: 'MS', profession: 'Master Plumber', rate: 'Rs.75/hr', rating: 4.9, reviews: 127, distance: '0.8 km',
        tags: ['Emergency Repairs', 'Pipe Installation', 'Leak Detection'],
        location: { city: 'Delhi', area: 'Connaught Place', lat: 28.6315, lng: 77.2167 }
      },
      {
        name: 'Rajeev Sharma', initials: 'RS', profession: 'Licensed Electrician', rate: 'Rs.80/hr', rating: 4.8, reviews: 89, distance: '1.2 km',
        tags: ['Wiring', 'Panel Upgrades', 'Smart Home'],
        location: { city: 'Gurugram', area: 'DLF Phase 3', lat: 28.4946, lng: 77.0880 }
      },
      {
        name: 'Mohit Raj', initials: 'MR', profession: 'Master Carpenter', rate: 'Rs.65/hr', rating: 4.9, reviews: 156, distance: '2.1 km',
        tags: ['Custom Furniture', 'Deck Building'],
        location: { city: 'Noida', area: 'Sector 18', lat: 28.5692, lng: 77.3250 }
      },
      {
        name: 'Tarun Kumar', initials: 'TK', profession: 'Professional Cleaner', rate: 'Rs.45/hr', rating: 5.0, reviews: 203, distance: '1.5 km',
